...
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.AddVnffgData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.AssocNewNsdVersionData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.ChangeExtVnfConnectivityData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.ChangeNsFlavourData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.ChangeVnfFlavourData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.InstantiateVnfData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.ModifyVnfInfoData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.MoveVnfInstanceData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.OperateVnfData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.SapData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.UpdateVnffgData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.elements.VnfInstanceData;
import it.nextworks.nfvmano.libs.osmanfvo.nslcm.interfaces.enums.NsUpdateType;
