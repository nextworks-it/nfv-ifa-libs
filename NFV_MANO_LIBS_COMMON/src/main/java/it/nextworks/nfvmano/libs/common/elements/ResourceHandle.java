...
/**
 * This information element provides information that allows addressing 
 * a resource that is used by a VNF instance.
 * 
 * Ref. IFA 013 v2.3.1 section 8.3.3.8
 * Ref. IFA 007 v2.3.1 section 8.5.7
 * 
 * @author nextworks
 *
 */
...
public class ResourceHandle implements DescriptorInformationElement {
	 ...
	 * Constructor
	 * 
	 * @param vimId Identifier of the VIM under whose control this resource is placed.
	 ...
	 */
	public ResourceHandle(String vimId, 
	 ...
	 * @param resourceProviderId Identifies the entity responsible for the management of the virtualised resource.
	 * @param resourceId Identifier of the resource in the scope of the VIM or the resource provider.
	 * @param vimLevelResourceType Type of the resource in the scope of the VIM or the resource provider. The value set of the "vimLevelResourceType" attribute is within the scope of the VIM or the resource provider and can be used as information that complements the ResourceHandle.
	 */
	public ResourceHandle(String vimId, 
			String resourceProviderId,
			String resourceId,
			String vimLevelResourceType) {
		this.vimId = vimId;
		this.resourceId = resourceId;
		this.resourceProviderId = resourceProviderId;
	...
	public void isValid() throws MalformattedElementException {
		if (resourceId == null) throw new MalformattedElementException("Resource Handle without resource ID");
