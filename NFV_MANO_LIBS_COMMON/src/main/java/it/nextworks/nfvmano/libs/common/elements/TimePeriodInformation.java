...
/**
 * This information element specifies a time period for which capacity is queried.
 * REF IFA 005 v2.3.1 - 8.7.2
 * 
 * @author nextworks
 *
 */
public class TimePeriodInformation implements DescriptorInformationElement {
	...
	public void isValid() throws MalformattedElementException {
		if (startTime == null) throw new MalformattedElementException("Time period information without start time");
