...
import it.nextworks.nfvmano.libs.descriptors.common.elements.SwImageDesc;
...
public class Appd implements DescriptorInformationElement {
	...
	@Embedded
	@JsonInclude(JsonInclude.Include.NON_EMPTY)
	private TerminateVnfOpConfig terminateAppInstanceOpConfig;
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY)
	private TerminateVnfOpConfig changeAppInstanceStateOpConfig;
	...
	public Appd(String appDId,
			    ...
			    TerminateVnfOpConfig terminateAppInstanceOpConfig,
			    TerminateVnfOpConfig changeAppInstanceStateOpConfig) {
		this.appDId = appDId;
	...
	public TerminateVnfOpConfig getTerminateAppInstanceOpConfig() {
	...
	public TerminateVnfOpConfig getChangeAppInstanceStateOpConfig() {
	...
	public void isValid() throws MalformattedElementException {
		...
		if (!(appDId.equals(appName))) throw new MalformattedElementException("Appd ID and appd name must be the same!");
	}
